...
namespace Microsoft.Azure.Management.IotCentral.Models
{
    ...
    /// </summary>
    public partial class CloudErrorResponseBody
    {
        /// <summary>
        /// Initializes a new instance of the ErrorResponseBody class.
        /// </summary>
        public CloudErrorResponseBody()
        {
            CustomInit();
        }
        ...
        /// error.</param>
        public CloudErrorResponseBody(string code = default(string), string message = default(string), string target = default(string), IList<CloudErrorResponseBody> details = default(IList<CloudErrorResponseBody>))
        {
            Code = code;
            Message = message;
            Target = target;
        ...
        public IList<CloudErrorResponseBody> Details { get; set; }
